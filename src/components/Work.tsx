                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-6 space-y-5">
                      ...
                      <div className="flex gap-x-4">
                        <div className="flex-shrink-0">{icons.Challenge}</div>
                        <div>
                          <p className="text-sm font-semibold text-white">Challenge</p>
                          <p className="mt-1 text-sm text-slate-400">{study.challenge}</p>
                        </div>
                      </div>
                      {/* Solution */}
                      <div className="flex gap-x-4">
                        <div className="flex-shrink-0">{icons.Solution}</div>
                        <div>
                          <p className="text-sm font-semibold text-white">Solution</p>
                          <p className="mt-1 text-sm text-slate-400">{study.solution}</p>
                        </div>
                      </div>
                      {/* Result */}
                       <div className="flex gap-x-4">
                        <div className="flex-shrink-0">{icons.Result}</div>
                        <div>
                          <p className="text-sm font-semibold text-white">Result</p>
                          <p className="mt-1 text-sm text-slate-400">{study.result}</p>
                        </div>
                      </div>
                    </div>
                  </div>
